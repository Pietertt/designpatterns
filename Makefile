compile:
	...
	@javac shapes/Shape.java shapes/BaseShape.java shapes/Group.java shapes/ResizableBorder.java shapes/Rectangle.java shapes/Ellipse.java shapes/Location.java
